...
const DISMISS_KEY = 'mindtrace:today-panel-dismissed-day';
const COLLAPSED_KEY = 'mindtrace:today-panel-collapsed';
const ACTIVE_TAB_KEY = 'mindtrace:today-panel-tab';
