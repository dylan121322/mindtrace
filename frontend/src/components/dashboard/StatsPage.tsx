...
const LAYOUT_KEY = 'mindtrace_stats_layout_v3';
const HIDDEN_KEY = 'mindtrace_stats_hidden_v1';
const VIEW_KEY = 'mindtrace_stats_view_v1';
const FUN_COLLAPSED_KEY = 'mindtrace_stats_fun_collapsed_v1';
