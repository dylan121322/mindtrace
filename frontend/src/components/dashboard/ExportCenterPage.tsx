    ...
    {target === 'webdav' && (
      <div className="space-y-2">
        ...
        <FormField label="上传路径前缀（可选）">
          <input type="text" value={config.webdav_path} placeholder="MindTrace-Export/"
    ...
    {target === 's3' && (
      <div className="space-y-2">
        ...
        <FormField label="路径前缀（可选）">
          <input type="text" value={config.s3_path_prefix} placeholder="mindtrace-export/"
    ...
    {target === 'dropbox' && (
      <div className="space-y-2">
        ...
        <FormField label="上传路径（可选）">
          <input type="text" value={config.dropbox_path} placeholder="/Apps/MindTrace/"
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <FormField label="文件夹路径">
            <input type="text" value={config.onedrive_folder_path} placeholder="MindTrace-Export"
