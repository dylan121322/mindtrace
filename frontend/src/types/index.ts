...
export type TabType = 'psych' | 'dashboard' | 'digest' | 'stats' | 'contacts' | 'db' | 'groups' | 'search' | 'calendar' | 'anniversary' | 'urls' | 'skills' | 'labs' | 'export' | 'memory' | 'visual' | 'debug' | 'scoring' | 'training' | 'settings';
